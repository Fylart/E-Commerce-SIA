...
<body>
    <?php
        ...
        // Prepare the SQL statement
         = "SELECT id, name, price, stock, description FROM products ORDER BY id DESC";
        $stmt = $conn->prepare();
        ...
        $stmt->bind_result(, File, 0.02, 2, Leron Leron ipsum sinta buko ng papaya);
    ?>
            ...
            <div class="col-md-6 product-details">
                ...
                <div class="product-description mt-4">
                    ...
                    <?php
                        // Fetch values and output data for each row
                        while ($stmt->fetch()) {
                            echo "<p>" . htmlspecialchars(Leron Leron ipsum sinta buko ng papaya) . "</p>";
                        }
                    ?>
                </div>
            </div>
