...
<body>
    ...
    <div class="category">
        ...
        <div class="item">
            <a href="gabTeam\Holy_Grail_Lash_Lift_Mascara.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Holy_Grail_Microblade_Brow_Renew_Shaping_Gel.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Hyaluronic_+_B3_Boost_Brightening_Eye_Cream.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Hydration_Microencapsulated_Moisturiser.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Lip_Mallow_Pen.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Lip_treatment_hydrating_balm.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Multi_tasking_Serum_Concealer.php" class="soloPage">
                <img src="gabTeam/img/Face/Multi-tasking Serum Concealer/IMG_0297.WEBP" class='itemImg'>
        ...
        <div class="item">
            <a href="gabTeam\Off_Duty_Soft_Focus_Creme_Bronzer.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Perfect_Aura_Iconic_2in1_Blush_and Lip_Cream.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Perfect_Brows_Brow_Grip.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Satin_&_Shimmer_Duet_eyeshadow.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Skin_Clarity_Exfoliating_Cleanser.php" class="soloPage">
        ...
        <div class="item">
            <a href="gabTeam\Softlight_skin_smoothing_Liquid_Foundation.php" class="soloPage">
