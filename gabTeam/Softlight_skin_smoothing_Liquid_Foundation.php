    ...
    <section class="product-container container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <button class="add-to-cart btn" onclick="addToCart('Softlight skin smoothing Liquid Foundation', 499, 'img/Face/Softlight skin smoothing Liquid Foundation/IMG_0293.WEBP')">Add to Cart</button>
