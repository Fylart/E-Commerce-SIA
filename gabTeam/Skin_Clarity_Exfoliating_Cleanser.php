...
<head>  
    ...
    <link href="assets/css/Skin Clarity Exfoliating Cleanser.css" rel="stylesheet">
    ...
    <section class="product-container container mt-4">
        <div class="row">
            <div class="col-md-6 product-image text-center">
                <img id="mainProductImage" src="img/Skin/Skin Clarity Exfoliating Cleanser/IMG_0336.WEBP" alt="Product Image" class="img-fluid rounded">
                <div class="product-thumbnails d-flex justify-content-center mt-4">
                    <img src="img/Skin/Skin Clarity Exfoliating Cleanser/IMG_0337.WEBP" alt="Thumbnail 1" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Skin/Skin Clarity Exfoliating Cleanser/IMG_0338.WEBP" alt="Thumbnail 2" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Skin/Skin Clarity Exfoliating Cleanser/IMG_0339.JPG" alt="Thumbnail 3" class="me-2 rounded" onclick="changeProductImage(this)">
                </div>
            </div>
            <div class="col-md-6 product-details">
                <h1 class="product-title">Skin Clarity Exfoliating Cleanser</h1>
                ...
                <button class="add-to-cart btn" onclick="addToCart('Skin Clarity Exfoliating Cleanser', 499, 'img/Skin/Skin Clarity Exfoliating Cleanser/IMG_0336.WEBP')">Add to Cart</button>

                <div class="product-description mt-4">
                    <p> Reveal your skin's natural radiance with this powerful exfoliating cleanser. Formulated with gentle exfoliants, it effectively removes impurities and dead skin cells while promoting a smoother, clearer complexion. Enriched with soothing ingredients, it cleanses without stripping moisture, leaving your skin refreshed and revitalized. Perfect for daily use, this cleanser is your essential step for glowing, healthy skin!</p>
                    <p class="section-title">Ingredients:</p>
                    <p>Glycolic Acid, Salicylic Acid, Aloe Vera Extract, Chamomile Extract.</p>
                    <p class="section-title">How to use:</p>
                    <p>Apply a small amount to wet skin, gently massage in circular motions, then rinse thoroughly. Use daily for a radiant complexion.</p>
                </div>
            </div>
        </div>
    </section>
