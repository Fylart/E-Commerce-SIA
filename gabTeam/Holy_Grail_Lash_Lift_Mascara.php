        ...
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <div class="product-description mt-4">
                    <p>Elevate your lashes with this versatile mascara that shapes, lifts, and volumizes for stunning results. Available in rich shades of Black and Brown, it delivers a lightweight yet long-lasting hold while nourishing your lashes. Perfect for achieving both dramatic and natural looks, this mascara is your go-to for all-day glamour!</p>
                    <p class="section-title">Ingredients:</p>
                    <p>Water, Glycerin, Butylene Glycol, Propanediol, Hydroxyethylcellulose, Acrylates/C10-30 Alkyl Acrylate Crosspolymer, Stearic Acid, Polyquaternium-10, Sodium Hyaluronate, Hydrolyzed Collagen, Panthenol, Tocopheryl Acetate, Phenoxyethanol, Ethylhexylglycerin, Fragrance.</p>
                    <p class="section-title">How to use:</p>
                    <p>Apply the mascara in a zig-zag motion from the base to the tips of your lashes, focusing on the outer corners for a lifted effect.</p>
                </div>
            </div>
        </div>
    </section>
