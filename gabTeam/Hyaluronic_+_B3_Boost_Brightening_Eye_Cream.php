...
<head>  
    ...
    <link href="assets/css/Hyaluronic + B3 Boost Brightening Eye Cream.css" rel="stylesheet">  
    <style>
       /* Cart Popup Styles */
       #cartPopup {
            position: fixed;
    ...
    <section class="product-container container mt-4">
        <div class="row">
            <div class="col-md-6 product-image text-center">
                <img id="mainProductImage" src="img/Skin/Hyaluronic + B3 Boost Brightening Eye Cream/IMG_0334.WEBP" alt="Product Image" class="img-fluid rounded">
                <div class="product-thumbnails d-flex justify-content-center mt-4">
                    <img src="img/Skin/Hyaluronic + B3 Boost Brightening Eye Cream/IMG_0333.WEBP" alt="Thumbnail 1" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Skin/Hyaluronic + B3 Boost Brightening Eye Cream/IMG_0335.JPG" alt="Thumbnail 2" class="me-2 rounded" onclick="changeProductImage(this)">
                </div>
            </div>
            <div class="col-md-6 product-details">
                <h1 class="product-title">Hyaluronic + B3 Boost Brightening Eye Cream</h1>
                ...
                <div class="product-description mt-4">
                    ...
                    <p>Water, Glycerin, Dimethicone, Cyclopentasiloxane, Hyaluronic Acid, Niacinamide (Vitamin B3), Caffeine, Peptides, Tocopheryl Acetate (Vitamin E), [May Contain/Peut Contenir (+/-): Iron Oxides (CI 77491, CI 77492, CI 77499)].</p>
                    <p class="section-title">How to use:</p>
                    <p>Apply a small amount to the under-eye area and gently pat until absorbed. Use morning and night for optimal results.</p>
                </div>
            </div>
        </div>
    </section>
