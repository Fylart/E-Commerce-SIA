    ...
    <section class="product-container container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <button class="add-to-cart btn" onclick="addToCart('Face Sculpting Microcurrent Spheres', 499, 'img/Face/Multi-tasking Serum Concealer/IMG_0297.WEBP')">Add to Cart</button>
