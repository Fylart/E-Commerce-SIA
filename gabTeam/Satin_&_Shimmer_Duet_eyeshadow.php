    ...
    <section class="product-container container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <button class="add-to-cart btn" onclick="addToCart('Satin & Shimmer Duet eyeshadow', 499, 'img/Eyes/Satin & Shimmer Duet eyeshadow/IMG_0289.WEBP')">Add to Cart</button>
