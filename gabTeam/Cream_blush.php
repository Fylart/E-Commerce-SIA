...
<head>  
    ...
    <link href="assets/css/creamblush.css" rel="stylesheet">  
    ...
    <section class="product-container container mt-4">
        <div class="row">
            <div class="col-md-6 product-image text-center">
                <img id="mainProductImage" src="img/Face/Creme Cushion Blush/IMG_0305.WEBP" alt="Product Image" class="img-fluid rounded">
                <div class="product-thumbnails d-flex justify-content-center mt-4">
                    <img src="img/Face/Creme Cushion Blush/IMG_0306.WEBP" alt="Thumbnail 1" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Face/Creme Cushion Blush/IMG_0307.WEBP" alt="Thumbnail 2" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Face/Creme Cushion Blush/IMG_0308.WEBP" alt="Thumbnail 3" class="me-2 rounded" onclick="changeProductImage(this)">
                </div>
            </div>
            <div class="col-md-6 product-details">
                <h1 class="product-title">Cream Blush</h1>
                ...
                <button class="add-to-cart btn" onclick="addToCart('Cream Blush', 499, 'img/Face/Creme Cushion Blush/IMG_0305.WEBP')">Add to Cart</button>
