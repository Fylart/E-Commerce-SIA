    ...
    <section class="product-container container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <button class="add-to-cart btn" onclick="addToCart('Hydration Microencapsulated Moisturiser', 499, 'img/Skin/Hydration Microencapsulated Moisturiser/IMG_0329.WEBP')">Add to Cart</button>
