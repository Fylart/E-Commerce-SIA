    ...
    <section class="product-container container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 product-details">
                ...
                <button class="add-to-cart btn" onclick="addToCart('Off Duty Soft Focus Creme Bronzer', 499, 'img/Face/Off Duty Soft Focus Creme Bronzer/IMG_0301.WEBP')">Add to Cart</button>
