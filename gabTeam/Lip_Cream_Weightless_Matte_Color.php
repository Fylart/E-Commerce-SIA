...
<head>  
    ...
    <link href="assets/css/Lip Cream Weightless Matte Color.css" rel="stylesheet">  
    <style>
        /* Cart Popup Styles */
 #cartPopup {
            position: fixed;
    ...
    <section class="product-container container mt-4">
        <div class="row">
            <div class="col-md-6 product-image text-center">
                <img id="mainProductImage" src="img/Lips/Lip Cream Weightless Matte Color/IMG_0317.WEBP" alt="Product Image" class="img-fluid rounded">
                <div class="product-thumbnails d-flex justify-content-center mt-4">
                    <img src="img/Lips/Lip Cream Weightless Matte Color/IMG_0318.WEBP" alt="Thumbnail 1" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Lips/Lip Cream Weightless Matte Color/IMG_0319.WEBP" alt="Thumbnail 2" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Lips/Lip Cream Weightless Matte Color/IMG_0320.WEBP" alt="Thumbnail 3" class="me-2 rounded" onclick="changeProductImage(this)">
                </div>
            </div>
            <div class="col-md-6 product-details">
                <h1 class="product-title">Lip Cream Weightless Matte Color</h1>
                ...
                <button class="add-to-cart btn" onclick="addToCart('Lip Cream Weightless Matte Color', 499, 'img/Lips/Lip Cream Weightless Matte Color/IMG_0317.WEBP')">Add to Cart</button>

                <div class="product-description mt-4">
                    <p> Experience the perfect blend of comfort and bold color with this weightless matte lip cream. Formulated for a soft, velvety finish, it glides on smoothly and provides long-lasting wear without drying out your lips. Available in a range of stunning shades, this lip cream is your go-to for a chic, effortless look that lasts all day!</p>
    ...
    <script>
        ...
        cartItems.forEach((item, index) => {
            ...
            cartItemElement.innerHTML = ` 
                <img src="img/Lips/Lip Mallow Pen/IMG_0316.WEBP" alt="${item.product}" style="width: 50px; height: 50px; margin-right: 10px;">
