...
<head>  
    ...
    <link href="assets/css/Multi-tasking Serum Concealer.css" rel="stylesheet">
    ...
    <section class="product-container container mt-4">
        <div class="row">
            <div class="col-md-6 product-image text-center">
                <img id="mainProductImage" src="img/Face/Multi-tasking Serum Concealer/IMG_0297.WEBP" alt="Product Image" class="img-fluid rounded">
                <div class="product-thumbnails d-flex justify-content-center mt-4">
                    <img src="img/Face/Multi-tasking Serum Concealer/IMG_0298.WEBP" alt="Thumbnail 1" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Face/Multi-tasking Serum Concealer/IMG_0299.WEBP" alt="Thumbnail 2" class="me-2 rounded" onclick="changeProductImage(this)">
                    <img src="img/Face/Multi-tasking Serum Concealer/IMG_0300.WEBP" alt="Thumbnail 3" class="me-2 rounded" onclick="changeProductImage(this)">
                </div>
            </div>
            <div class="col-md-6 product-details">
                <h1 class="product-title">Multi-tasking Serum Concealer</h1>
                ...
                <button class="add-to-cart btn" onclick="addToCart('Multi-tasking Serum Concealer', 499, 'img/Face/Multi-tasking Serum Concealer/IMG_0297.WEBP')">Add to Cart</button>
    ...
    <script>
        ...
        cartItems.forEach((item, index) => {
            ...
            cartItemElement.innerHTML = ` 
                <img src="img/Face/Multi-tasking Serum Concealer/IMG_0297.WEBP" alt="${item.product}" style="width: 50px; height: 50px; margin-right: 10px;">
